        ...
        <div className="grid mb-8 lg:grid-cols-6">
          ...
          <div className="md:max-w-md lg:col-span-2 lg:mt-0 mt-5">
            ...
            <p className="mt-4 text-sm text-gray-500">
              ...
              Accusantium animi consectetur quae. Maiores voluptas, nulla eum
              dolorum rem, consequatur minima deserunt animi saepe totam
              voluptatibus vel exercitationem accusamus amet quia.
            </p>
          </div>
        </div>
